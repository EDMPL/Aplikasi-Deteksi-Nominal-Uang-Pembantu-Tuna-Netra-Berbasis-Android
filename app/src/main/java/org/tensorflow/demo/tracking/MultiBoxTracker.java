  ...
  public synchronized void drawDebug(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      if (getFrameToCanvasMatrix().mapRect(trackedPos)) {
        final String labelString1 = String.format("%.2f", trackedObject.getCurrentCorrelation());
        borderedText.drawText(canvas, trackedPos.right, trackedPos.bottom, labelString1);
      }
    }
